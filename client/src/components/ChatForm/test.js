...
function InputEmoji ({
    ...
    const replaceAllTextEmojis = useCallback((text) => {
        ...
        allEmojis.forEach(emoji => {
            ...
            text,
            emoji,
            `<img data-emoji="${emoji}" src="https://upload.wikimedia.org/wikipedia/commons/c/ce/Transparent.gif" />`
            )
        })
        }
    ...
    const [ replaceAllTextEmojiToStringDebounced ] = useDebounce(replaceAllTextEmojiToString, 100)
